...
console.log(contact);
        ...
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.post('http://localhost:8084/api/reclamations',contact,httpOptions1)
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
...
console.log(JSON.stringify(contact.id));
        ...
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.put('http://localhost:8084/api/reclamations',contact,httpOptions1)
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
...
/*
    ...
    deleteContact(contact): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.delete('http://localhost:8084/api/reclamations/' +contact.id,httpOptions1)
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
