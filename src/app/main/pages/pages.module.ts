...
import { ReclamationUserModule } from './reclamation/user/reclamation-user.module';
import { ReclamationDirecteurModule } from './reclamation/directeur/reclamation-directeur.module';
import { ReclamationAdminModule } from './reclamation/admin/reclamation-admin.module';
import { ReclamationAssistantModule } from './reclamation/assistant/reclamation-assistant.module';
...
@NgModule({
    imports: [
        ...
        // Knowledge base
        KnowledgeBaseModule,
        ReclamationUserModule,
        ReclamationDirecteurModule,
        ReclamationAdminModule,
        ReclamationAssistantModule
    ]
})
