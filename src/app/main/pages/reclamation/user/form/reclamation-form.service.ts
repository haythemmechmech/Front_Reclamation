...
import { ReclamationUserFormComponent } from './reclamation-form.component';
import { Nm_Etat, INm_Etat } from 'app/model/etat.model';
...
@Injectable()
export class ReclamationUserFormService implements Resolve<any>
{
    routeParams: any;
    reclamation: Reclamation;
    onReclamationChanged: BehaviorSubject<any>;
    etats:any;
    etatbyid: Array<Nm_Etat>;
    ...
    getActionById(id): any
    {
     ...
     return   this._httpClient.get<IAction>('http://localhost:8084/api/actions/'+id  ,httpOptions);
