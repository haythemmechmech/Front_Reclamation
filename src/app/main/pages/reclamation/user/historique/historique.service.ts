...
@Injectable()
export class ReclamationUserHistoriqueService implements Resolve<any>
{
    reclamations: any[];
...
let a=JSON.parse(sessionStorage.getItem('user')).firstName+" "+JSON.parse(sessionStorage.getItem('user')).lastName;
        ...
        return new Promise((resolve, reject) => {
            this._httpClient.get('http://localhost:8084/api/reclamations/created_by=' +a,httpOptions)
